...
class _PresensiScreenScreenState extends State<PresensiScreen> {
        ...
        builder: (builder){
          return Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.symmetric(horizontal: 20),
                child: Text("Pilih bulan",style: TextStyle(color: Colors.black.withOpacity(0.4)),),
              ),
              SizedBox(height: 20,),
              Expanded(
                child: ListView(
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text("Januari", style: TextStyle(color: MyColors.grey_80),)),
                              ),
                            ),
                          ),
                        ),
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text("Februari", style: TextStyle(color: MyColors.grey_80),)),
                              ),
                            ),
                          ),
                        ),
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text("Maret", style: TextStyle(color: MyColors.grey_80),)),
                              ),
                            ),
                          ),
                        ),
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text("April", style: TextStyle(color: MyColors.grey_80),)),
                              ),
                            ),
                          ),
                        ),
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text("Mei", style: TextStyle(color: MyColors.grey_80),)),
                              ),
                            ),
                          ),
                        ),
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text("Juni", style: TextStyle(color: MyColors.grey_80),)),
                              ),
                            ),
                          ),
                        ),
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text("Juli", style: TextStyle(color: MyColors.grey_80),)),
                              ),
                            ),
                          ),
                        ),
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text("Agustus", style: TextStyle(color: MyColors.grey_80),)),
                              ),
                            ),
                          ),
                        ),
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text("September", style: TextStyle(color: MyColors.grey_80),)),
                              ),
                            ),
                          ),
                        ),
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text("Oktober", style: TextStyle(color: MyColors.grey_80),)),
                              ),
                            ),
                          ),
                        ),
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text("November", style: TextStyle(color: MyColors.grey_80),)),
                              ),
                            ),
                          ),
                        ),
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text("Desember", style: TextStyle(color: MyColors.grey_80),)),
                              ),
                            ),
                          ),
                        ),
                            ...
                            child: Container(
                              ...
                              child: Center(child: Row(
                                children: [
                                  ...
                                  Text(DateFormat("MMM").format(DateTime(2000, selectedMonth + 6,2)), style: TextStyle(color: MyColors.primary),),
                                ],
                              )),
                            ),
                          ),
  ...
  List<Widget> generateList(){
    return _presensiResponse?.laporan?.where((element) {
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Text(DateFormat("dd MMM yyyy").format(e.detail?.tanggal ?? DateTime.now()), style: TextStyle(fontSize: 16),),
              Spacer(),
              Text(e.detail?.kehadiran == "H" ? "Hadir" : "Absen", style: TextStyle(fontSize: 12,color: e.detail?.kehadiran == "H" ? Colors.green : Colors.red),),
            ],
          ),
          SizedBox(height: 10,),
        ],
