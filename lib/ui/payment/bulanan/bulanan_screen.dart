  ...
  List<Widget> buildWidget() {
    return _response?.detail?.where((element) {
          ...
          if (selectedYear != null && yearStart != 0 && yearEnd != 0) {
            return yearStart >= (selectedYear?.getStart() ?? 0) &&
                yearEnd <= (selectedYear?.getEnd() ?? 0);
          } else {
            return true;
          }
        }).map((e) {
          ...
          return Column(
            children: [
              TreeViewChild(
                  ...
                  children: model.items.where((element) {
                    if (listFilter[2].isFilterActive &&
                        !listFilter[1].isFilterActive) {
                  ...
                  child: Card(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            "TAGIHAN PER ${DateFormat("dd MMM yyyy").format(DateTime.now()).toUpperCase()}",
                            style: TextStyle(color: MyColors.grey_60),
                          ),
                          SizedBox(
                            height: 10,
